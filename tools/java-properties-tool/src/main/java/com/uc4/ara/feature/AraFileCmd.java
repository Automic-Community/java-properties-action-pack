...
public class AraFileCmd {
	...
	public static void main(String[] args) {
		FeatureUtil.logMsg("java-properties-tool", MsgTypes.GENERAL);
		FeatureUtil.logMsg("(c) Automic Software GmbH", MsgTypes.GENERAL);
		try {			
			FeatureUtil.logMsg("Version: "
					+ FeatureUtil.getCompiledVersion("java-properties-tool"), MsgTypes.GENERAL);
			
			FeatureUtil.logMsg("Date: "
					+ FeatureUtil
					.getCompiledDate("java-properties-tool"), MsgTypes.GENERAL);
			FeatureUtil.logMsg("");
